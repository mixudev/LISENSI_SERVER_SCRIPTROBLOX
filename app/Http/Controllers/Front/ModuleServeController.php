...
class ModuleServeController extends Controller
{
    ...
    private function fetchFromGithub(\App\Models\ModuleAccessToken $accessToken, string $sanitized): string
    {
    ...
    private function fetchFromLocal(\App\Models\ModuleAccessToken $accessToken, string $sanitized): string
    {
