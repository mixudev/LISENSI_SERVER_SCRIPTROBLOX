...
class InjectTestController extends Controller
{
    ...
    public function run(Request $request): JsonResponse
    {
        ...
        $method1 = "-- METODE 1 (Direkomendasikan — 1 baris)\n"
            ."loadstring(game:HttpGet(\"{$getUrl}?key={$key}&hwid=\" .. tostring(game:GetService(\"Players\").LocalPlayer.UserId) .. \"&username=\" .. game:GetService(\"Players\").LocalPlayer.Name .. \"&place=\" .. tostring(game.PlaceId)))()\n\n"
            ."-- METODE 2 (Via Loader.lua)\n"
            ."getgenv().script_key = \"{$key}\"\n"
            ."loadstring(game:HttpGet(\"{$loaderUrl}\"))()";

        $steps[] = ['step' => 'loader_url', 'status' => 'ok',
            'detail' => "URL Loader.lua: {$loaderUrl}\nURL GET inject: {$getUrl}\n\n{$method1}"];
