...
<div class="space-y-4" data-product-form="{{ $formId }}">
    ...
    <div class="grid grid-cols-2 gap-3">
        ...
        <div class="col-span-2 sm:col-span-1">
            ...
            <input type="text" name="name" required placeholder="contoh: VIP, Premium..."
                ...
                value="{{ old('name', $product?->name) }}" class="modal-input">
    ...
    <div id="{{ $formId }}-github" class="{{ $isGithub ? '' : 'hidden' }} space-y-3">
        ...
        <p class="text-[10px] text-slate-400">Sistem otomatis mendeteksi <code>loader.lua</code> di repo. Modul di folder yang sama akan di-serve via <code>/modules/{token}/</code>.</p>
    ...
    <div class="grid grid-cols-2 gap-3 pt-2 border-t border-slate-100 dark:border-slate-800">
        ...
        <div>
            ...
            <p class="text-[10px] text-slate-400 mt-1">Pisahkan dengan koma. Kosong = kompatibel semua game.</p>
