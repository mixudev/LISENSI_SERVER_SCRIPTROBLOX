        ...
        <div id="sidebar-footer-area" class="flex items-center">
            <div id="user-card"
                ...
                <div class="sidebar-user-info overflow-hidden">
                    <div class="text-sm font-medium text-slate-800 dark:text-slate-200 truncate whitespace-nowrap">{{ $user->name }}</div>
                    <div class="text-[11px] text-slate-400 truncate whitespace-nowrap">Super Admin</div>
                </div>
                <svg class="sidebar-user-chevron w-4 h-4 text-slate-400 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
